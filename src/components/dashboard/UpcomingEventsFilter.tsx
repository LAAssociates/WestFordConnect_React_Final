...
interface UpcomingEventsFilterProps {
  isOpen: boolean;
  onClose: () => void;
...
const UpcomingEventsFilter: React.FC<UpcomingEventsFilterProps> = ({
  isOpen,
  onClose,
  triggerRef,
  onApply,
  initialFilters = { viewType: 'myEvents', timeFrame: 'today' },
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (event: MouseEvent | TouchEvent) => {
      ...
      const filterPanel = document.querySelector('[data-filter-panel="upcoming-events"]');
  ...
  return createPortal(
    <>
      {/* Filter Panel */}
      <div
        data-filter-panel="upcoming-events"
