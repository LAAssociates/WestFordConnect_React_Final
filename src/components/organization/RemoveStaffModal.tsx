      ...
      >
        ...
        <div className="p-6">
          ...
          <p className="text-base text-gray-700 mb-6">
            This will remove the selected person and their subordinates.
          </p>
          ...
          <div className="flex items-center justify-center gap-[10px] px-[25px]">
            <button
              ...
              className="flex-1 px-6 py-2 border border-gray-300 rounded-[25px] text-sm font-semibold text-red-600 hover:bg-gray-50 transition cursor-pointer"
            >
              Delete
            </button>
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-6 py-2 border border-gray-300 rounded-[25px] text-sm font-semibold text-gray-900 hover:bg-gray-50 transition cursor-pointer"
            >
              Cancel
            </button>
          </div>
