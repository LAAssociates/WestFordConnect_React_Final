...
interface ChangesDiscardedModalProps {
  isOpen: boolean;
  onClose: () => void;
}

const ChangesDiscardedModal: React.FC<ChangesDiscardedModalProps> = ({
  isOpen,
  onClose,
}) => {
      ...
      >
        ...
        <div className="p-6">
          <div className="flex items-center gap-[5px] mb-5">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Changes Discarded</h3>
          </div>

          <p className="text-base text-gray-700 mb-5 leading-normal">
            All unsaved edits have been removed. The org chart is now back to its last saved state.
          </p>
...
export default ChangesDiscardedModal;
