...
import type { Task, TaskSortOption } from './types';
...
const KanbanColumn: React.FC<KanbanColumnProps> = ({
    ...
    return (
        <div className="border-2 border-[#E6E6E6] rounded-[10px] flex flex-col overflow-auto">
            ...
            {/* Tasks List */}
            <div className="flex-1 overflow-y-auto px-[15px] space-y-[15px]">
                {tasks.length === 0 ? (
                    <div className="text-center py-8 text-[#535352] text-sm">No tasks</div>
                ) : (
                    tasks.map((task) => (
                        <TaskCard
                            key={task.id}
