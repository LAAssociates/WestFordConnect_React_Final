...
interface PasswordUpdatedSuccessModalProps {
    isOpen: boolean;
    onClose: () => void;
    logoutAllDevices: boolean;
}

const PasswordUpdatedSuccessModal: React.FC<PasswordUpdatedSuccessModalProps> = ({
    isOpen,
    onClose,
    logoutAllDevices,
}) => {
    ...
    return createPortal(
        ...
        >
            <div
                className="relative bg-[#16A34A] rounded-[10px] w-full max-w-[371px] shadow-xl"
            ...
            >
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                        <mask id="mask0_success" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x="0" y="0" width="22" height="22">
